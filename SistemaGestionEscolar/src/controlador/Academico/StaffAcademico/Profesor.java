...
public class Profesor extends Persona {
	 ...
	 * @return
	 */
	public static String registrarPromedio(String rutEst, int idCurso, String prom,String rutProfesor) {
		try {
			//Verificar que se ingrese numero o decimal
			if (esNumero(prom)){
			//Convertir promedio string a decimal
			double promedio = Double.parseDouble(prom);
			...
			} return "Ingrese un dato entero o decimal";		
		} catch (PersistentException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	 ...
	 * @return
	 */
	public static String registrarAsistencia(String rutEst, int idCurso, String asis,String rutProfesor) {
		try {
			//Verificar que se ingrese numero o decimal
			if (esNumero(asis)){
			//Convertir promedio string a decimal
			double asistencia = Double.parseDouble(asis);
			// Condicion de busqueda del estudiante (rut persona)
			String queryEstudiante = "persona.rut='" + rutEst+ "'";
			// Se almacena en la variable el estudiante con la condicion entregada
			orm.Estudiante lormEstudiante = orm.EstudianteDAO.loadEstudianteByQuery(queryEstudiante, null);
