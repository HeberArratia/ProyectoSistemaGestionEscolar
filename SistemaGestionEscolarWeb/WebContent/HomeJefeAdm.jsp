                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Bienvenido Jefe AdministraciÃ³n <small></small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-10 ">
                                        ...
                                        <div>Registrar sueldo profesor por curso.</div>
                                    </div>
                                </div>
                            </div>
                            <a href="RegistrarSueldo.jsp">
                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-10 ">
                                        ...
                                        <div>Crear curso y asignar profesor.</div>
                                    </div>
                                </div>
                            </div>
                            <a href="CrearCurso.jsp">
                                <div class="panel-footer">
                                    <span class="pull-left">Ingresar</span>
                                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                    <div class="clearfix"></div>
