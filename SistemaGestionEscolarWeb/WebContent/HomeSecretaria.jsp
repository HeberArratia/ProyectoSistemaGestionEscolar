                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Bienvenida Secretaria<small></small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-10 ">
                                        ...
                                        <div>Registrar pago de matrícula por estudiante.</div>
                                    </div>
                                </div>
                            </div>
                            <a href="PagoMatricula.jsp">
                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-10 ">
                                        ...
                                        <div>Registrar pago de mensualidad por estudiante.</div>
                                    </div>
                                </div>
                            </div>
                            <a href="PagoMensualidad.jsp">
                                <div class="panel-footer">
                                    <span class="pull-left">Ingresar</span>
                                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                    <div class="clearfix"></div>
