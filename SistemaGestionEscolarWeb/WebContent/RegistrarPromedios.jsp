    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-fw fa-table"></i> Registrar ingreso de notas finales (promedio final).
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="row">
                  <div class="col-sm-5">
                        <form action="RegistrarPromedio" method="post">  
                            ...
                            <div class="form-inline">   
                             ...
                             <label>Ingrese código del curso:</label>                
                             <div class="form-group">   
                                <input name="codigoCurso" class="form-control" required> 
                            </div> 
                            <label>Ingrese promedio:</label>                
                             <div class="form-group">   
                                <input name="promedio" class="form-control" required> 
                            </div>                            
