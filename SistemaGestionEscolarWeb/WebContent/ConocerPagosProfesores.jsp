<%@page import="servicio.ServicioSueldoProxy"%>
...
<body>
    ...
    <div id="wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-table"></i> Conocer pagos profesores por curso y si fue realizado.
                            </li>
                        </ol>
                    </div>
                </div>
                 ...
                 <div class="row">
                    <div class="col-lg-12">
                        <form action="ObtenerSueldos" method="post" >
                            <label>Ingrese rut del profesor:</label>
                             <div class="form-inline">
                                <input name="rutprofesor" class="form-control" required> 
                                <button type="submit" class="btn btn-primary">Obtener sueldos</button> 
                            </div>
		...
		<% 
        	...
        	String[][] datos;
       if (json!=null){
        	if (json.equals("No existe el profesor")){ %>
        		<p>No existe el profesor</p>
        <% } else {
