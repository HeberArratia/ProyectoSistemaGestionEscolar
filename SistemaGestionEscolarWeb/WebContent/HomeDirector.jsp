                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Bienvenido Director <small></small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-10 ">
                                        ...
                                        <div>Obtener reporte estudiantes morosos en los pagos de matrÃ­cula.</div>
                                    </div>
                                </div>
                            </div>
                            <a href="ObtenerMorososMatricula.jsp">
                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-10 ">
                                        ...
                                        <div>Obtener reporte estudiantes morosos en los pagos de mensualidad.</div>
                                    </div>
                                </div>
                            </div>
                            <a href="ObtenerMorososMensualidad.jsp">
                                <div class="panel-footer">
                                    <span class="pull-left">Ingresar</span>
                                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                    <div class="clearfix"></div>
                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-10 ">
                                        ...
                                        <div>Conocer pagos profesores por curso y si fue realizado.</div>
                                    </div>
                                </div>
                            </div>
                            <a href="ConocerPagosProfesores.jsp">
                                <div class="panel-footer">
                                    <span class="pull-left">Ingresar</span>
                                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                    <div class="clearfix"></div>
                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-10 ">
                                        ...
                                        <div>Desactivar Curso.</div>
                                    </div>
                                </div>
                            </div>
                            <a href="DesactivarCurso.jsp">
                                <div class="panel-footer">
                                    <span class="pull-left">Ingresar</span>
                                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                    <div class="clearfix"></div>
                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-10 ">
                                        ...
                                        <div>Obtener balance de ingreso y gasto.</div>
                                    </div>
                                </div>
                            </div>
                            <a href="BalanceIngresoGasto.jsp">
                                <div class="panel-footer">
                                    <span class="pull-left">Ingresar</span>
                                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                    <div class="clearfix"></div>
