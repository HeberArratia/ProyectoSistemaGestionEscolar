...
public class ServicioMensualidadServiceLocator extends org.apache.axis.client.Service implements servicio.ServicioMensualidadService {
    ...
    private java.lang.String ServicioMensualidad_address = "http://localhost:8080/SistemaGestionEscolarServicio/services/ServicioMensualidad";
    ...
    public servicio.ServicioMensualidad getServicioMensualidad() throws javax.xml.rpc.ServiceException {
    ...
    public servicio.ServicioMensualidad getServicioMensualidad(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            servicio.ServicioMensualidadSoapBindingStub _stub = new servicio.ServicioMensualidadSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (servicio.ServicioMensualidad.class.isAssignableFrom(serviceEndpointInterface)) {
                servicio.ServicioMensualidadSoapBindingStub _stub = new servicio.ServicioMensualidadSoapBindingStub(new java.net.URL(ServicioMensualidad_address), this);
                _stub.setPortName(getServicioMensualidadWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://servicio", "ServicioMensualidadService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://servicio", "ServicioMensualidad"));
        }
